...
class delsol_import_clients(models.Model):
    
    _name = "delsol.client_imp"


    bianchi_client_number = fields.Integer("id de la base de datos")

    cliente = fields.Char("Nombre-Cuil/t")
